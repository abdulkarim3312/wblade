...
<section id="terms">
    <div class="container wrapper mt-5">
      <div class="row">
        <div class="col-2"></div>
        <div class="col-8">
          <h1 class="terms_header">{{ $privacy? $privacy->main_title: '' }}</h1>
          <h4 class="terms_sub">Date of Last Revision: {{ \Carbon\Carbon::parse($privacy ? $privacy->updated_at: '')->format('F d, Y')}}</h4>
          <p class="term_pera"><span>{!! $privacy ? $privacy->description: '' !!}</span></p>
